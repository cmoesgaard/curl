...
int test(char *URL)
{
  ...
  test_setopt(carl, CARLOPT_REFERER, "http://example.com/the-moo");
  test_setopt(carl, CARLOPT_USERAGENT, "the-moo agent next generation");
  test_setopt(carl, CARLOPT_COOKIE, "name=moo");
