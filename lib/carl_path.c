...
CARLcode Curl_getworkingpath(struct Curl_easy *data,
                                             ...
                                             real path to work with */
{
  ...
  if(data->conn->handler->protocol & CARLPROTO_SCP) {
  ...
  else if(data->conn->handler->protocol & CARLPROTO_SFTP) {
 ...
 */
CARLcode Curl_get_pathname(const char **cpp, char **path, char *homedir)
{
