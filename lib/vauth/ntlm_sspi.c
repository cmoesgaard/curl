                                             ...
                                             char **outptr, size_t *outlen)
{
  ...
  type_1_buf.cbBuffer   = carlx_uztoul(ntlm->token_max);
                                             ...
                                             char **outptr, size_t *outlen)
{
  ...
  type_2_bufs[0].cbBuffer   = carlx_uztoul(ntlm->input_token_len);
  ...
  */
  ...
  type_3_buf.cbBuffer   = carlx_uztoul(ntlm->token_max);
