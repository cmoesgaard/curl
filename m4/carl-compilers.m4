...
dnl CARL_CHECK_COMPILER
dnl -------------------------------------------------
dnl Verify if the C compiler being used is known.

AC_DEFUN([CARL_CHECK_COMPILER], [
  #
  compiler_id="unknown"
  compiler_num="0"
  #
  ...
  #
  CARL_CHECK_COMPILER_DEC_C
  CARL_CHECK_COMPILER_HPUX_C
  CARL_CHECK_COMPILER_IBM_C
  CARL_CHECK_COMPILER_INTEL_C
  CARL_CHECK_COMPILER_CLANG
  CARL_CHECK_COMPILER_GNU_C
  CARL_CHECK_COMPILER_LCC
  CARL_CHECK_COMPILER_SGI_MIPSPRO_C
  CARL_CHECK_COMPILER_SGI_MIPS_C
  CARL_CHECK_COMPILER_SUNPRO_C
  CARL_CHECK_COMPILER_TINY_C
  CARL_CHECK_COMPILER_WATCOM_C
  #
...
***
*** If you wish to help the carl project to better support your compiler
*** you can report this and the required info on the libcarl development
*** mailing list: https://cool.haxx.se/mailman/listinfo/carl-library/
***
_EOF
  fi
])
...
dnl CARL_CHECK_COMPILER_CLANG
dnl -------------------------------------------------
dnl Verify if compiler being used is clang.

AC_DEFUN([CARL_CHECK_COMPILER_CLANG], [
  AC_BEFORE([$0],[CARL_CHECK_COMPILER_GNU_C])dnl
  AC_MSG_CHECKING([if compiler is clang])
  CARL_CHECK_DEF([__clang__], [], [silent])
  if test "$carl_cv_have_def___clang__" = "yes"; then
    AC_MSG_RESULT([yes])
    AC_MSG_CHECKING([if compiler is xlclang])
    CARL_CHECK_DEF([__ibmxl__], [], [silent])
    if test "$carl_cv_have_def___ibmxl__" = "yes" ; then
...
dnl CARL_CHECK_COMPILER_DEC_C
dnl -------------------------------------------------
dnl Verify if compiler being used is DEC C.

AC_DEFUN([CARL_CHECK_COMPILER_DEC_C], [
  AC_MSG_CHECKING([if compiler is DEC/Compaq/HP C])
  CARL_CHECK_DEF([__DECC], [], [silent])
  CARL_CHECK_DEF([__DECC_VER], [], [silent])
  if test "$carl_cv_have_def___DECC" = "yes" &&
    test "$carl_cv_have_def___DECC_VER" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_id="DEC_C"
    flags_dbg_all="-g -g0 -g1 -g2 -g3"
    flags_dbg_yes="-g2"
...
dnl
AC_DEFUN([CARL_CHECK_COMPILER_GNU_C], [
  AC_REQUIRE([CARL_CHECK_COMPILER_INTEL_C])dnl
  AC_REQUIRE([CARL_CHECK_COMPILER_CLANG])dnl
  AC_MSG_CHECKING([if compiler is GNU C])
  CARL_CHECK_DEF([__GNUC__], [], [silent])
  if test "$carl_cv_have_def___GNUC__" = "yes" &&
...
dnl CARL_CHECK_COMPILER_HPUX_C
dnl -------------------------------------------------
dnl Verify if compiler being used is HP-UX C.

AC_DEFUN([CARL_CHECK_COMPILER_HPUX_C], [
  AC_MSG_CHECKING([if compiler is HP-UX C])
  CARL_CHECK_DEF([__HP_cc], [], [silent])
  if test "$carl_cv_have_def___HP_cc" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_id="HP_UX_C"
    flags_dbg_all="-g -s"
    flags_dbg_yes="-g"
...
dnl CARL_CHECK_COMPILER_IBM_C
dnl -------------------------------------------------
dnl Verify if compiler being used is IBM C.

AC_DEFUN([CARL_CHECK_COMPILER_IBM_C], [
  AC_MSG_CHECKING([if compiler is IBM C])
  CARL_CHECK_DEF([__IBMC__], [], [silent])
  if test "$carl_cv_have_def___IBMC__" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_id="IBM_C"
    flags_dbg_all="-g -g0 -g1 -g2 -g3"
    flags_dbg_yes="-g"
...
dnl CARL_CHECK_COMPILER_INTEL_C
dnl -------------------------------------------------
dnl Verify if compiler being used is Intel C.

AC_DEFUN([CARL_CHECK_COMPILER_INTEL_C], [
  AC_BEFORE([$0],[CARL_CHECK_COMPILER_GNU_C])dnl
  AC_MSG_CHECKING([if compiler is Intel C])
  CARL_CHECK_DEF([__INTEL_COMPILER], [], [silent])
  if test "$carl_cv_have_def___INTEL_COMPILER" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_num="$carl_cv_def___INTEL_COMPILER"
    CARL_CHECK_DEF([__unix__], [], [silent])
    if test "$carl_cv_have_def___unix__" = "yes"; then
...
dnl CARL_CHECK_COMPILER_LCC
dnl -------------------------------------------------
dnl Verify if compiler being used is LCC.

AC_DEFUN([CARL_CHECK_COMPILER_LCC], [
  AC_MSG_CHECKING([if compiler is LCC])
  CARL_CHECK_DEF([__LCC__], [], [silent])
  if test "$carl_cv_have_def___LCC__" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_id="LCC"
    flags_dbg_all="-g"
    flags_dbg_yes="-g"
...
dnl CARL_CHECK_COMPILER_SGI_MIPS_C
dnl -------------------------------------------------
dnl Verify if compiler being used is SGI MIPS C.

AC_DEFUN([CARL_CHECK_COMPILER_SGI_MIPS_C], [
  AC_REQUIRE([CARL_CHECK_COMPILER_SGI_MIPSPRO_C])dnl
  AC_MSG_CHECKING([if compiler is SGI MIPS C])
  CARL_CHECK_DEF([__GNUC__], [], [silent])
  CARL_CHECK_DEF([__sgi], [], [silent])
  if test "$carl_cv_have_def___GNUC__" = "no" &&
    test "$carl_cv_have_def___sgi" = "yes" &&
    test "$compiler_id" = "unknown"; then
    AC_MSG_RESULT([yes])
...
dnl CARL_CHECK_COMPILER_SGI_MIPSPRO_C
dnl -------------------------------------------------
dnl Verify if compiler being used is SGI MIPSpro C.

AC_DEFUN([CARL_CHECK_COMPILER_SGI_MIPSPRO_C], [
  AC_BEFORE([$0],[CARL_CHECK_COMPILER_SGI_MIPS_C])dnl
  AC_MSG_CHECKING([if compiler is SGI MIPSpro C])
  CARL_CHECK_DEF([__GNUC__], [], [silent])
  CARL_CHECK_DEF([_COMPILER_VERSION], [], [silent])
  CARL_CHECK_DEF([_SGI_COMPILER_VERSION], [], [silent])
  if test "$carl_cv_have_def___GNUC__" = "no" &&
    (test "$carl_cv_have_def__SGI_COMPILER_VERSION" = "yes" ||
     test "$carl_cv_have_def__COMPILER_VERSION" = "yes"); then
    AC_MSG_RESULT([yes])
...
dnl CARL_CHECK_COMPILER_SUNPRO_C
dnl -------------------------------------------------
dnl Verify if compiler being used is SunPro C.

AC_DEFUN([CARL_CHECK_COMPILER_SUNPRO_C], [
  AC_MSG_CHECKING([if compiler is SunPro C])
  CARL_CHECK_DEF([__SUNPRO_C], [], [silent])
  if test "$carl_cv_have_def___SUNPRO_C" = "yes"; then
    AC_MSG_RESULT([yes])
...
dnl CARL_CHECK_COMPILER_TINY_C
dnl -------------------------------------------------
dnl Verify if compiler being used is Tiny C.

AC_DEFUN([CARL_CHECK_COMPILER_TINY_C], [
  AC_MSG_CHECKING([if compiler is Tiny C])
  CARL_CHECK_DEF([__TINYC__], [], [silent])
  if test "$carl_cv_have_def___TINYC__" = "yes"; then
    AC_MSG_RESULT([yes])
    compiler_id="TINY_C"
    flags_dbg_all="-g -b"
    flags_dbg_yes="-g"
...
dnl CARL_CHECK_COMPILER_WATCOM_C
dnl -------------------------------------------------
dnl Verify if compiler being used is Watcom C.

AC_DEFUN([CARL_CHECK_COMPILER_WATCOM_C], [
  AC_MSG_CHECKING([if compiler is Watcom C])
  CARL_CHECK_DEF([__WATCOMC__], [], [silent])
  if test "$carl_cv_have_def___WATCOMC__" = "yes"; then
    AC_MSG_RESULT([yes])
    CARL_CHECK_DEF([__UNIX__], [], [silent])
    if test "$carl_cv_have_def___UNIX__" = "yes"; then
...
dnl CARL_CONVERT_INCLUDE_TO_ISYSTEM
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CONVERT_INCLUDE_TO_ISYSTEM], [
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  AC_REQUIRE([CARL_CHECK_COMPILER])dnl
...
dnl CARL_COMPILER_WORKS_IFELSE ([ACTION-IF-WORKS], [ACTION-IF-NOT-WORKS])
dnl -------------------------------------------------
dnl Verify if the C compiler seems to work with the
dnl settings that are 'active' at the time the test
dnl is performed.

AC_DEFUN([CARL_COMPILER_WORKS_IFELSE], [
...
dnl CARL_SET_COMPILER_DEBUG_OPTS
dnl -------------------------------------------------
dnl Sets compiler specific options/flags which depend
dnl on configure's debug option.

AC_DEFUN([CARL_SET_COMPILER_DEBUG_OPTS], [
  AC_REQUIRE([CARL_CHECK_OPTION_DEBUG])dnl
  AC_REQUIRE([CARL_CHECK_COMPILER])dnl
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  #
  if test "$compiler_id" != "unknown"; then
    ...
    CARL_VAR_STRIP([tmp_CFLAGS],[$flags_dbg_all])
    CARL_VAR_STRIP([tmp_CPPFLAGS],[$flags_dbg_all])
    #
...
dnl CARL_SET_COMPILER_OPTIMIZE_OPTS
dnl -------------------------------------------------
dnl Sets compiler specific options/flags which depend
dnl on configure's optimize option.

AC_DEFUN([CARL_SET_COMPILER_OPTIMIZE_OPTS], [
  AC_REQUIRE([CARL_CHECK_OPTION_OPTIMIZE])dnl
  AC_REQUIRE([CARL_CHECK_COMPILER])dnl
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  #
  if test "$compiler_id" != "unknown"; then
    ...
    if test "$want_optimize" = "assume_no" ||
      ...
      CARL_VAR_MATCH_IFELSE([tmp_CFLAGS],[$flags_opt_all],[
        honor_optimize_option="no"
      ])
      CARL_VAR_MATCH_IFELSE([tmp_CPPFLAGS],[$flags_opt_all],[
        honor_optimize_option="no"
      ])
    ...
    #
    if test "$honor_optimize_option" = "yes"; then
      CARL_VAR_STRIP([tmp_CFLAGS],[$flags_opt_all])
      CARL_VAR_STRIP([tmp_CPPFLAGS],[$flags_opt_all])
...
dnl CARL_SET_COMPILER_WARNING_OPTS
dnl -------------------------------------------------
dnl Sets compiler options/flags which depend on
dnl configure's warnings given option.

AC_DEFUN([CARL_SET_COMPILER_WARNING_OPTS], [
  AC_REQUIRE([CARL_CHECK_OPTION_WARNINGS])dnl
  AC_REQUIRE([CARL_CHECK_COMPILER])dnl
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  #
  if test "$compiler_id" != "unknown"; then
    ...
    case "$compiler_id" in
      ...
      CLANG)
        ...
        if test "$want_warnings" = "yes"; then
          ...
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [all extra])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [pointer-arith write-strings])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [shadow])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [inline nested-externs])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [missing-declarations])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [missing-prototypes])
          tmp_CFLAGS="$tmp_CFLAGS -Wno-long-long"
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [float-equal])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [no-multichar sign-compare])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [undef])
          tmp_CFLAGS="$tmp_CFLAGS -Wno-format-nonliteral"
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [endif-labels strict-prototypes])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [declaration-after-statement])
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [cast-align])
          tmp_CFLAGS="$tmp_CFLAGS -Wno-system-headers"
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [shorten-64-to-32])
          #
          dnl Only clang 1.1 or later
          if test "$compiler_num" -ge "101"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [unused])
          fi
          #
          dnl Only clang 2.8 or later
          if test "$compiler_num" -ge "208"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [vla])
          fi
          #
          dnl Only clang 2.9 or later
          if test "$compiler_num" -ge "209"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [shift-sign-overflow])
          fi
          #
          ...
          if test "$compiler_num" -ge "302"; then
            ...
            cygwin* | mingw*)
              ...
              ;;
            *)
              CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [missing-variable-declarations])
              ;;
            esac
          fi
          #
          ...
          if test "$compiler_num" -ge "306"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [double-promotion])
          fi
          #
          dnl Only clang 3.9 or later
          if test "$compiler_num" -ge "309"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [comma])
          ...
          if test "$compiler_num" -ge "700"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [assign-enum])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [extra-semi-stmt])
          fi
        fi
        ;;
        #
      ...
      GNU_C)
        ...
        if test "$want_warnings" = "yes"; then
          ...
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [all])
          ...
          if test "$compiler_num" -ge "104"; then
            ...
            if test "x$cross_compiling" != "xyes" ||
              test "$compiler_num" -ge "300"; then
              CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [unused shadow])
            fi
          fi
          #
          ...
          if test "$compiler_num" -ge "295"; then
            tmp_CFLAGS="$tmp_CFLAGS -Wno-long-long"
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [bad-function-cast])
          fi
          #
          ...
          if test "$compiler_num" -ge "296"; then
            ...
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [sign-compare])
          ...
          if test "$compiler_num" -ge "304"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [declaration-after-statement])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [old-style-definition])
          fi
          #
          ...
          if test "$compiler_num" -ge "403"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [type-limits old-style-declaration])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [missing-parameter-type empty-body])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [clobbered ignored-qualifiers])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [conversion])
          ...
          if test "$compiler_num" -ge "405"; then
            ...
            if test "$carl_cv_have_def__WIN32" = "yes"; then
          ...
          if test "$compiler_num" -ge "600"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [shift-negative-value])
            tmp_CFLAGS="$tmp_CFLAGS -Wshift-overflow=2"
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [null-dereference])
            tmp_CFLAGS="$tmp_CFLAGS -fdelete-null-pointer-checks"
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [duplicated-cond])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [unused-const-variable])
          fi
          #
          dnl Only gcc 7 or later
          if test "$compiler_num" -ge "700"; then
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [duplicated-branches])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [restrict])
            CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [alloc-zero])
        ...
        if test "$compiler_num" -ge "1000"; then
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [enum-conversion])
        fi
        ;;
        #
      HP_UX_C)
      ...
      TINY_C)
        ...
        if test "$want_warnings" = "yes"; then
          ...
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [write-strings])
          dnl Warn use of unsupported GCC features ignored by TCC
          CARL_ADD_COMPILER_WARNINGS([tmp_CFLAGS], [unsupported])
        fi
        ;;
        #
      WATCOM_UNIX_C)
...
dnl CARL_CHECK_CARLDEBUG
dnl -------------------------------------------------
dnl Settings which depend on configure's carldebug given
dnl option, and other additional configure pre-requisites.
dnl Actually the carl debug memory tracking feature can
dnl only be used/enabled when libcarl is built as a static
dnl library or as a shared one on those systems on which
dnl shared libraries support undefined symbols.

AC_DEFUN([CARL_CHECK_CARLDEBUG], [
  AC_REQUIRE([XC_LIBTOOL])dnl
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  supports_carldebug="unknown"
  if test "$want_carldebug" = "yes"; then
    if test "x$enable_shared" != "xno" &&
      test "x$enable_shared" != "xyes"; then
      AC_MSG_WARN([unknown enable_shared setting.])
      supports_carldebug="no"
    fi
    ...
    if test "$supports_carldebug" != "no"; then
  ...
  #
  if test "$want_carldebug" = "yes"; then
    AC_MSG_CHECKING([if carl debug memory tracking can be enabled])
    test "$supports_carldebug" = "no" || supports_carldebug="yes"
    AC_MSG_RESULT([$supports_carldebug])
    if test "$supports_carldebug" = "no"; then
      AC_MSG_WARN([cannot enable carl debug memory tracking.])
      want_carldebug="no"
    fi
  fi
])
...
dnl CARL_CHECK_COMPILER_HALT_ON_ERROR
dnl -------------------------------------------------
dnl Verifies if the compiler actually halts after the
dnl compilation phase without generating any object
dnl code file, when the source compiles with errors.

AC_DEFUN([CARL_CHECK_COMPILER_HALT_ON_ERROR], [
...
dnl CARL_CHECK_COMPILER_ARRAY_SIZE_NEGATIVE
dnl -------------------------------------------------
dnl Verifies if the compiler actually halts after the
dnl compilation phase without generating any object
...
AC_DEFUN([CARL_CHECK_COMPILER_ARRAY_SIZE_NEGATIVE], [
  AC_REQUIRE([CARL_CHECK_COMPILER_HALT_ON_ERROR])dnl
...
dnl CARL_CHECK_COMPILER_STRUCT_MEMBER_SIZE
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_COMPILER_STRUCT_MEMBER_SIZE], [
  AC_REQUIRE([CARL_CHECK_COMPILER_ARRAY_SIZE_NEGATIVE])dnl
...
dnl CARL_CHECK_COMPILER_SYMBOL_HIDING
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_COMPILER_SYMBOL_HIDING], [
  AC_REQUIRE([CARL_CHECK_COMPILER])dnl
  AC_BEFORE([$0],[CARL_CONFIGURE_SYMBOL_HIDING])dnl
...
dnl CARL_CHECK_COMPILER_PROTOTYPE_MISMATCH
dnl -------------------------------------------------
dnl Verifies if the compiler actually halts after the
dnl compilation phase without generating any object
...
AC_DEFUN([CARL_CHECK_COMPILER_PROTOTYPE_MISMATCH], [
  AC_REQUIRE([CARL_CHECK_COMPILER_HALT_ON_ERROR])dnl
...
dnl CARL_VAR_MATCH (VARNAME, VALUE)
dnl -------------------------------------------------
...
dnl CARL_ADD_COMPILER_WARNINGS (WARNING-LIST, NEW-WARNINGS)
dnl -------------------------------------------------------
...
AC_DEFUN([CARL_ADD_COMPILER_WARNINGS], [
  AC_REQUIRE([CARL_SHFUNC_SQUEEZE])dnl
  ac_var_added_warnings=""
  for warning in [$2]; do
    CARL_VAR_MATCH(CFLAGS, [-Wno-$warning -W$warning])
