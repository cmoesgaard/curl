...
dnl CARL_INCLUDES_ARPA_INET
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when arpa/inet.h is to be included.

AC_DEFUN([CARL_INCLUDES_ARPA_INET], [
carl_includes_arpa_inet="\
/* includes start */
...
dnl CARL_INCLUDES_FCNTL
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when fcntl.h is to be included.

AC_DEFUN([CARL_INCLUDES_FCNTL], [
carl_includes_fcntl="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
...
dnl CARL_INCLUDES_IFADDRS
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when ifaddrs.h is to be included.

AC_DEFUN([CARL_INCLUDES_IFADDRS], [
carl_includes_ifaddrs="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_INTTYPES
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when inttypes.h is to be included.

AC_DEFUN([CARL_INCLUDES_INTTYPES], [
carl_includes_inttypes="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
# include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_LIBGEN
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when libgen.h is to be included.

AC_DEFUN([CARL_INCLUDES_LIBGEN], [
carl_includes_libgen="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_NETDB
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when netdb.h is to be included.

AC_DEFUN([CARL_INCLUDES_NETDB], [
carl_includes_netdb="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
...
dnl CARL_INCLUDES_POLL
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when poll.h is to be included.

AC_DEFUN([CARL_INCLUDES_POLL], [
carl_includes_poll="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
...
dnl CARL_INCLUDES_SETJMP
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when setjmp.h is to be included.

AC_DEFUN([CARL_INCLUDES_SETJMP], [
carl_includes_setjmp="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SIGNAL
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when signal.h is to be included.

AC_DEFUN([CARL_INCLUDES_SIGNAL], [
carl_includes_signal="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SOCKET
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when socket.h is to be included.

AC_DEFUN([CARL_INCLUDES_SOCKET], [
carl_includes_socket="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_STDIO
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when stdio.h is to be included.

AC_DEFUN([CARL_INCLUDES_STDIO], [
carl_includes_stdio="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
...
dnl CARL_INCLUDES_STDLIB
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when stdlib.h is to be included.

AC_DEFUN([CARL_INCLUDES_STDLIB], [
carl_includes_stdlib="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_STRING
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when string(s).h is to be included.

AC_DEFUN([CARL_INCLUDES_STRING], [
carl_includes_string="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_STROPTS
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when stropts.h is to be included.

AC_DEFUN([CARL_INCLUDES_STROPTS], [
carl_includes_stropts="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SYS_SOCKET
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when sys/socket.h is to be included.

AC_DEFUN([CARL_INCLUDES_SYS_SOCKET], [
carl_includes_sys_socket="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SYS_TYPES
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when sys/types.h is to be included.

AC_DEFUN([CARL_INCLUDES_SYS_TYPES], [
carl_includes_sys_types="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SYS_UIO
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when sys/uio.h is to be included.

AC_DEFUN([CARL_INCLUDES_SYS_UIO], [
carl_includes_sys_uio="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_SYS_XATTR
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when sys/xattr.h is to be included.

AC_DEFUN([CARL_INCLUDES_SYS_XATTR], [
carl_includes_sys_xattr="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_TIME
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when time.h is to be included.

AC_DEFUN([CARL_INCLUDES_TIME], [
...
dnl CARL_INCLUDES_UNISTD
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when unistd.h is to be included.

AC_DEFUN([CARL_INCLUDES_UNISTD], [
carl_includes_unistd="\
/* includes start */
#ifdef HAVE_SYS_TYPES_H
#  include <sys/types.h>
#endif
...
dnl CARL_INCLUDES_WINSOCK2
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when winsock(2).h is to be included.

AC_DEFUN([CARL_INCLUDES_WINSOCK2], [
carl_includes_winsock2="\
/* includes start */
...
#endif
/* includes end */"
  CARL_CHECK_HEADER_WINDOWS
  CARL_CHECK_HEADER_WINSOCK
  CARL_CHECK_HEADER_WINSOCK2
])


dnl CARL_INCLUDES_WS2TCPIP
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when ws2tcpip.h is to be included.

AC_DEFUN([CARL_INCLUDES_WS2TCPIP], [
carl_includes_ws2tcpip="\
/* includes start */
#ifdef HAVE_WINDOWS_H
#  ifndef WIN32_LEAN_AND_MEAN
#    define WIN32_LEAN_AND_MEAN
...
/* includes end */"
  CARL_CHECK_HEADER_WINDOWS
  CARL_CHECK_HEADER_WINSOCK2
  CARL_CHECK_HEADER_WS2TCPIP
])


dnl CARL_INCLUDES_BSDSOCKET
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when bsdsocket.h is to be included.

AC_DEFUN([CARL_INCLUDES_BSDSOCKET], [
carl_includes_bsdsocket="\
/* includes start */
...
dnl CARL_INCLUDES_NETIF
dnl -------------------------------------------------
dnl Set up variable with list of headers that must be
dnl included when net/if.h is to be included.

AC_DEFUN([CARL_INCLUDES_NETIF], [
carl_includes_netif="\
/* includes start */
#ifdef HAVE_NET_IF_H
#  include <net/if.h>
...
dnl CARL_CHECK_FUNC_ALARM
dnl -------------------------------------------------
dnl Verify if alarm is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_alarm, then
dnl HAVE_ALARM will be defined.

AC_DEFUN([CARL_CHECK_FUNC_ALARM], [
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  #
  ...
  if test "$tst_compi_alarm" = "yes"; then
    ...
    if test "x$carl_disallow_alarm" != "xyes"; then
      AC_MSG_RESULT([yes])
      tst_allow_alarm="yes"
    else
      AC_MSG_RESULT([no])
  ...
  if test "$tst_links_alarm" = "yes" &&
    ...
    carl_cv_func_alarm="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_alarm="no"
  fi
])


dnl CARL_CHECK_FUNC_BASENAME
dnl -------------------------------------------------
dnl Verify if basename is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_basename, then
dnl HAVE_BASENAME will be defined.

AC_DEFUN([CARL_CHECK_FUNC_BASENAME], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  AC_REQUIRE([CARL_INCLUDES_LIBGEN])dnl
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  #
  ...
  if test "$tst_compi_basename" = "yes"; then
    ...
    if test "x$carl_disallow_basename" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_basename" = "yes" &&
    ...
    carl_cv_func_basename="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_basename="no"
  fi
])


dnl CARL_CHECK_FUNC_CLOSESOCKET
dnl -------------------------------------------------
dnl Verify if closesocket is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_closesocket, then
dnl HAVE_CLOSESOCKET will be defined.

AC_DEFUN([CARL_CHECK_FUNC_CLOSESOCKET], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_SOCKET])dnl
  #
  ...
  if test "$tst_compi_closesocket" = "yes"; then
    ...
    if test "x$carl_disallow_closesocket" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_closesocket" = "yes" &&
    ...
    carl_cv_func_closesocket="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_closesocket="no"
  fi
])


dnl CARL_CHECK_FUNC_CLOSESOCKET_CAMEL
dnl -------------------------------------------------
dnl Verify if CloseSocket is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_closesocket_camel,
dnl then HAVE_CLOSESOCKET_CAMEL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_CLOSESOCKET_CAMEL], [
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  #
  ...
  if test "$tst_compi_closesocket_camel" = "yes"; then
    AC_MSG_CHECKING([if CloseSocket usage allowed])
    if test "x$carl_disallow_closesocket_camel" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_closesocket_camel" = "yes" &&
    ...
    carl_cv_func_closesocket_camel="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_closesocket_camel="no"
  fi
])


dnl CARL_CHECK_FUNC_CONNECT
dnl -------------------------------------------------
dnl Verify if connect is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_connect, then
dnl HAVE_CONNECT will be defined.

AC_DEFUN([CARL_CHECK_FUNC_CONNECT], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  AC_REQUIRE([CARL_INCLUDES_SOCKET])dnl
  #
  ...
  if test "$tst_compi_connect" = "yes"; then
    ...
    if test "x$carl_disallow_connect" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_connect" = "yes" &&
    ...
    carl_cv_func_connect="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_connect="no"
  fi
])


dnl CARL_CHECK_FUNC_FCNTL
dnl -------------------------------------------------
dnl Verify if fcntl is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_fcntl, then
dnl HAVE_FCNTL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FCNTL], [
  AC_REQUIRE([CARL_INCLUDES_FCNTL])dnl
  #
  ...
  if test "$tst_compi_fcntl" = "yes"; then
    ...
    if test "x$carl_disallow_fcntl" != "xyes"; then
      AC_MSG_RESULT([yes])
      tst_allow_fcntl="yes"
    else
      AC_MSG_RESULT([no])
  ...
  if test "$tst_links_fcntl" = "yes" &&
    ...
    carl_cv_func_fcntl="yes"
    CARL_CHECK_FUNC_FCNTL_O_NONBLOCK
  else
    AC_MSG_RESULT([no])
    carl_cv_func_fcntl="no"
  fi
])


dnl CARL_CHECK_FUNC_FCNTL_O_NONBLOCK
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_FCNTL_O_NONBLOCK], [
  #
  ...
  case $host_os in
    sunos4* | aix3* | beos*)
      ...
      carl_disallow_fcntl_o_nonblock="yes"
      ;;
  esac
  #
  if test "$carl_cv_func_fcntl" = "yes"; then
  ...
  if test "$tst_compi_fcntl_o_nonblock" = "yes"; then
    ...
    if test "x$carl_disallow_fcntl_o_nonblock" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_fcntl_o_nonblock" = "yes" &&
    ...
    carl_cv_func_fcntl_o_nonblock="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_fcntl_o_nonblock="no"
  fi
])

dnl CARL_CHECK_FUNC_FGETXATTR
dnl -------------------------------------------------
dnl Verify if fgetxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_fgetxattr, then
dnl HAVE_FGETXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FGETXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_fgetxattr" = "yes"; then
    ...
    if test "x$carl_disallow_fgetxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_fgetxattr" = "yes" &&
    ...
    #
    carl_cv_func_fgetxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_fgetxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_FLISTXATTR
dnl -------------------------------------------------
dnl Verify if flistxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_flistxattr, then
dnl HAVE_FLISTXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FLISTXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_flistxattr" = "yes"; then
    ...
    if test "x$carl_disallow_flistxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_flistxattr" = "yes" &&
    ...
    #
    carl_cv_func_flistxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_flistxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_FREEADDRINFO
dnl -------------------------------------------------
...
dnl shell variable carl_disallow_freeaddrinfo, then
dnl HAVE_FREEADDRINFO will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FREEADDRINFO], [
  AC_REQUIRE([CARL_INCLUDES_WS2TCPIP])dnl
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_freeaddrinfo" = "yes"; then
    ...
    if test "x$carl_disallow_freeaddrinfo" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_freeaddrinfo" = "yes" &&
    ...
    carl_cv_func_freeaddrinfo="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_freeaddrinfo="no"
  fi
])


dnl CARL_CHECK_FUNC_FREEIFADDRS
dnl -------------------------------------------------
dnl Verify if freeifaddrs is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_freeifaddrs, then
dnl HAVE_FREEIFADDRS will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FREEIFADDRS], [
  AC_REQUIRE([CARL_INCLUDES_IFADDRS])dnl
  #
  ...
  if test "$tst_compi_freeifaddrs" = "yes"; then
    ...
    if test "x$carl_disallow_freeifaddrs" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_freeifaddrs" = "yes" &&
    ...
    carl_cv_func_freeifaddrs="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_freeifaddrs="no"
  fi
])


dnl CARL_CHECK_FUNC_FREMOVEXATTR
dnl -------------------------------------------------
dnl Verify if fremovexattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_fremovexattr, then
dnl HAVE_FREMOVEXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FREMOVEXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_fremovexattr" = "yes"; then
    ...
    if test "x$carl_disallow_fremovexattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_fremovexattr" = "yes" &&
    ...
    #
    carl_cv_func_fremovexattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_fremovexattr="no"
  fi
])


dnl CARL_CHECK_FUNC_FSETXATTR
dnl -------------------------------------------------
dnl Verify if fsetxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_fsetxattr, then
dnl HAVE_FSETXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FSETXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_fsetxattr" = "yes"; then
    ...
    if test "x$carl_disallow_fsetxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_fsetxattr" = "yes" &&
    ...
    #
    carl_cv_func_fsetxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_fsetxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_FTRUNCATE
dnl -------------------------------------------------
dnl Verify if ftruncate is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_ftruncate, then
dnl HAVE_FTRUNCATE will be defined.

AC_DEFUN([CARL_CHECK_FUNC_FTRUNCATE], [
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  #
  ...
  if test "$tst_compi_ftruncate" = "yes"; then
    ...
    if test "x$carl_disallow_ftruncate" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_ftruncate" = "yes" &&
    ...
    carl_cv_func_ftruncate="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ftruncate="no"
  fi
])


dnl CARL_CHECK_FUNC_GETADDRINFO
dnl -------------------------------------------------
dnl Verify if getaddrinfo is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_getaddrinfo, then
...
AC_DEFUN([CARL_CHECK_FUNC_GETADDRINFO], [
  AC_REQUIRE([CARL_INCLUDES_WS2TCPIP])dnl
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  AC_REQUIRE([CARL_CHECK_NATIVE_WINDOWS])dnl
  #
  ...
  if test "$tst_compi_getaddrinfo" = "yes" &&
    ...
    if test "x$carl_disallow_getaddrinfo" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getaddrinfo" = "yes" &&
    ...
    carl_cv_func_getaddrinfo="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getaddrinfo="no"
    carl_cv_func_getaddrinfo_threadsafe="no"
  fi
  #
  if test "$carl_cv_func_getaddrinfo" = "yes"; then
    ...
    if test "$tst_tsafe_getaddrinfo" = "unknown" &&
       test "$carl_cv_native_windows" = "yes"; then
      tst_tsafe_getaddrinfo="yes"
    fi
    if test "$tst_tsafe_getaddrinfo" = "unknown"; then
      CARL_CHECK_DEF_CC([h_errno], [
        $carl_includes_sys_socket
        $carl_includes_netdb
        ], [silent])
      if test "$carl_cv_have_def_h_errno" = "yes"; then
    ...
    if test "$tst_tsafe_getaddrinfo" = "yes"; then
      ...
      carl_cv_func_getaddrinfo_threadsafe="yes"
    else
      carl_cv_func_getaddrinfo_threadsafe="no"
    fi
  fi
...
dnl CARL_CHECK_FUNC_GETHOSTBYADDR
dnl -------------------------------------------------
dnl Verify if gethostbyaddr is available, prototyped,
dnl and can be compiled. If all of these are true,
dnl and usage has not been previously disallowed with
dnl shell variable carl_disallow_gethostbyaddr, then
dnl HAVE_GETHOSTBYADDR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETHOSTBYADDR], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_gethostbyaddr" = "yes"; then
    ...
    if test "x$carl_disallow_gethostbyaddr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gethostbyaddr" = "yes" &&
    ...
    carl_cv_func_gethostbyaddr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gethostbyaddr="no"
  fi
])

dnl CARL_CHECK_FUNC_GAI_STRERROR
dnl -------------------------------------------------
dnl Verify if gai_strerror is available, prototyped,
dnl and can be compiled. If all of these are true,
dnl and usage has not been previously disallowed with
dnl shell variable carl_disallow_gai_strerror, then
dnl HAVE_GAI_STRERROR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GAI_STRERROR], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_gai_strerror" = "yes"; then
    ...
    if test "x$carl_disallow_gai_strerror" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gai_strerror" = "yes" &&
    ...
    carl_cv_func_gai_strerror="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gai_strerror="no"
  fi
])


dnl CARL_CHECK_FUNC_GETHOSTBYADDR_R
dnl -------------------------------------------------
dnl Verify if gethostbyaddr_r is available, prototyped,
dnl and can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_gethostbyaddr_r, then
dnl HAVE_GETHOSTBYADDR_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETHOSTBYADDR_R], [
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_gethostbyaddr_r" = "yes"; then
    ...
    if test "x$carl_disallow_gethostbyaddr_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gethostbyaddr_r" = "yes" &&
    ...
    #
    carl_cv_func_gethostbyaddr_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gethostbyaddr_r="no"
  fi
])


dnl CARL_CHECK_FUNC_GETHOSTBYNAME
dnl -------------------------------------------------
dnl Verify if gethostbyname is available, prototyped,
dnl and can be compiled. If all of these are true,
dnl and usage has not been previously disallowed with
dnl shell variable carl_disallow_gethostbyname, then
dnl HAVE_GETHOSTBYNAME will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETHOSTBYNAME], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_gethostbyname" = "yes"; then
    ...
    if test "x$carl_disallow_gethostbyname" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gethostbyname" = "yes" &&
    ...
    carl_cv_func_gethostbyname="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gethostbyname="no"
  fi
])


dnl CARL_CHECK_FUNC_GETHOSTBYNAME_R
dnl -------------------------------------------------
dnl Verify if gethostbyname_r is available, prototyped,
dnl and can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_gethostbyname_r, then
dnl HAVE_GETHOSTBYNAME_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETHOSTBYNAME_R], [
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_gethostbyname_r" = "yes"; then
    ...
    if test "x$carl_disallow_gethostbyname_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gethostbyname_r" = "yes" &&
    ...
    #
    carl_cv_func_gethostbyname_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gethostbyname_r="no"
  fi
])


dnl CARL_CHECK_FUNC_GETHOSTNAME
dnl -------------------------------------------------
dnl Verify if gethostname is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_gethostname, then
dnl HAVE_GETHOSTNAME will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETHOSTNAME], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  AC_REQUIRE([CARL_PREPROCESS_CALLCONV])dnl
  AC_REQUIRE([CARL_INCLUDES_BSDSOCKET])dnl
  #
  ...
  if test "$tst_compi_gethostname" = "yes"; then
    ...
    if test "x$carl_disallow_gethostname" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gethostname" = "yes" &&
    ...
    carl_cv_func_gethostname="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gethostname="no"
  fi
])

dnl CARL_CHECK_FUNC_GETPEERNAME
dnl -------------------------------------------------
dnl Verify if getpeername is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_getpeername, then
dnl HAVE_GETPEERNAME will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETPEERNAME], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  AC_REQUIRE([CARL_PREPROCESS_CALLCONV])dnl
  AC_REQUIRE([CARL_INCLUDES_BSDSOCKET])dnl
  ...
  if test "$tst_compi_getpeername" = "yes"; then
    ...
    if test "x$carl_disallow_getpeername" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getpeername" = "yes" &&
    ...
    carl_cv_func_getpeername="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getpeername="no"
  fi
])

dnl CARL_CHECK_FUNC_GETSOCKNAME
dnl -------------------------------------------------
dnl Verify if getsockname is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_getsockname, then
dnl HAVE_GETSOCKNAME will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETSOCKNAME], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_UNISTD])dnl
  AC_REQUIRE([CARL_PREPROCESS_CALLCONV])dnl
  AC_REQUIRE([CARL_INCLUDES_BSDSOCKET])dnl
  ...
  if test "$tst_compi_getsockname" = "yes"; then
    ...
    if test "x$carl_disallow_getsockname" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getsockname" = "yes" &&
    ...
    carl_cv_func_getsockname="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getsockname="no"
  fi
])

dnl CARL_CHECK_FUNC_IF_NAMETOINDEX
dnl -------------------------------------------------
dnl Verify if if_nametoindex is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_if_nametoindex, then
dnl HAVE_IF_NAMETOINDEX will be defined.

AC_DEFUN([CARL_CHECK_FUNC_IF_NAMETOINDEX], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_NETIF])dnl
  AC_REQUIRE([CARL_PREPROCESS_CALLCONV])dnl
  #
  ...
  if test "$tst_compi_if_nametoindex" = "yes"; then
    ...
    if test "x$carl_disallow_if_nametoindex" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_if_nametoindex" = "yes" &&
    ...
    carl_cv_func_if_nametoindex="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_if_nametoindex="no"
  fi
])


dnl CARL_CHECK_FUNC_GETIFADDRS
dnl -------------------------------------------------
dnl Verify if getifaddrs is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_getifaddrs, then
dnl HAVE_GETIFADDRS will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETIFADDRS], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_IFADDRS])dnl
  #
  ...
  if test "$tst_compi_getifaddrs" = "yes" &&
    ...
    if test "x$carl_disallow_getifaddrs" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getifaddrs" = "yes" &&
    ...
    carl_cv_func_getifaddrs="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getifaddrs="no"
  fi
])


dnl CARL_CHECK_FUNC_GETSERVBYPORT_R
dnl -------------------------------------------------
dnl Verify if getservbyport_r is available, prototyped,
dnl and can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_getservbyport_r, then
dnl HAVE_GETSERVBYPORT_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETSERVBYPORT_R], [
  AC_REQUIRE([CARL_INCLUDES_NETDB])dnl
  #
  ...
  if test "$tst_compi_getservbyport_r" = "yes"; then
    ...
    if test "x$carl_disallow_getservbyport_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getservbyport_r" = "yes" &&
    ...
    carl_cv_func_getservbyport_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getservbyport_r="no"
  fi
])


dnl CARL_CHECK_FUNC_GETXATTR
dnl -------------------------------------------------
dnl Verify if getxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_getxattr, then
dnl HAVE_GETXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GETXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_getxattr" = "yes"; then
    ...
    if test "x$carl_disallow_getxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_getxattr" = "yes" &&
    ...
    #
    carl_cv_func_getxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_getxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_GMTIME_R
dnl -------------------------------------------------
dnl Verify if gmtime_r is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_gmtime_r, then
dnl HAVE_GMTIME_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_GMTIME_R], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_TIME])dnl
  #
  ...
  if test "$tst_compi_gmtime_r" = "yes" &&
    ...
    if test "x$carl_disallow_gmtime_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_gmtime_r" = "yes" &&
    ...
    carl_cv_func_gmtime_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_gmtime_r="no"
  fi
])


dnl CARL_CHECK_FUNC_INET_NTOA_R
dnl -------------------------------------------------
dnl Verify if inet_ntoa_r is available, prototyped,
dnl and can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_inet_ntoa_r, then
dnl HAVE_INET_NTOA_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_INET_NTOA_R], [
  AC_REQUIRE([CARL_INCLUDES_ARPA_INET])dnl
  #
  ...
  if test "$tst_compi_inet_ntoa_r" = "yes"; then
    ...
    if test "x$carl_disallow_inet_ntoa_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_inet_ntoa_r" = "yes" &&
    ...
    #
    carl_cv_func_inet_ntoa_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_inet_ntoa_r="no"
  fi
])


dnl CARL_CHECK_FUNC_INET_NTOP
dnl -------------------------------------------------
dnl Verify if inet_ntop is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_inet_ntop, then
dnl HAVE_INET_NTOP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_INET_NTOP], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_ARPA_INET])dnl
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_inet_ntop" = "yes" &&
    ...
    if test "x$carl_disallow_inet_ntop" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_inet_ntop" = "yes" &&
    ...
    carl_cv_func_inet_ntop="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_inet_ntop="no"
  fi
])


dnl CARL_CHECK_FUNC_INET_PTON
dnl -------------------------------------------------
dnl Verify if inet_pton is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_inet_pton, then
dnl HAVE_INET_PTON will be defined.

AC_DEFUN([CARL_CHECK_FUNC_INET_PTON], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_ARPA_INET])dnl
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_inet_pton" = "yes" &&
    ...
    if test "x$carl_disallow_inet_pton" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_inet_pton" = "yes" &&
    ...
    carl_cv_func_inet_pton="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_inet_pton="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTL
dnl -------------------------------------------------
dnl Verify if ioctl is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_ioctl, then
dnl HAVE_IOCTL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_IOCTL], [
  AC_REQUIRE([CARL_INCLUDES_STROPTS])dnl
  #
  ...
  if test "$tst_compi_ioctl" = "yes"; then
    ...
    if test "x$carl_disallow_ioctl" != "xyes"; then
      AC_MSG_RESULT([yes])
      tst_allow_ioctl="yes"
    else
      AC_MSG_RESULT([no])
  ...
  if test "$tst_links_ioctl" = "yes" &&
    ...
    carl_cv_func_ioctl="yes"
    CARL_CHECK_FUNC_IOCTL_FIONBIO
    CARL_CHECK_FUNC_IOCTL_SIOCGIFADDR
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctl="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTL_FIONBIO
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_IOCTL_FIONBIO], [
  #
  tst_compi_ioctl_fionbio="unknown"
  tst_allow_ioctl_fionbio="unknown"
  #
  if test "$carl_cv_func_ioctl" = "yes"; then
  ...
  if test "$tst_compi_ioctl_fionbio" = "yes"; then
    ...
    if test "x$carl_disallow_ioctl_fionbio" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_ioctl_fionbio" = "yes" &&
    ...
    carl_cv_func_ioctl_fionbio="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctl_fionbio="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTL_SIOCGIFADDR
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_IOCTL_SIOCGIFADDR], [
  #
  ...
  if test "$tst_compi_ioctl_siocgifaddr" = "yes"; then
    ...
    if test "x$carl_disallow_ioctl_siocgifaddr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_ioctl_siocgifaddr" = "yes" &&
    ...
    carl_cv_func_ioctl_siocgifaddr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctl_siocgifaddr="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTLSOCKET
dnl -------------------------------------------------
dnl Verify if ioctlsocket is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_ioctlsocket, then
dnl HAVE_IOCTLSOCKET will be defined.

AC_DEFUN([CARL_CHECK_FUNC_IOCTLSOCKET], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  #
  ...
  if test "$tst_compi_ioctlsocket" = "yes"; then
    ...
    if test "x$carl_disallow_ioctlsocket" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_ioctlsocket" = "yes" &&
    ...
    carl_cv_func_ioctlsocket="yes"
    CARL_CHECK_FUNC_IOCTLSOCKET_FIONBIO
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctlsocket="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTLSOCKET_FIONBIO
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_IOCTLSOCKET_FIONBIO], [
  #
  tst_compi_ioctlsocket_fionbio="unknown"
  tst_allow_ioctlsocket_fionbio="unknown"
  #
  if test "$carl_cv_func_ioctlsocket" = "yes"; then
  ...
  if test "$tst_compi_ioctlsocket_fionbio" = "yes"; then
    ...
    if test "x$carl_disallow_ioctlsocket_fionbio" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_ioctlsocket_fionbio" = "yes" &&
    ...
    carl_cv_func_ioctlsocket_fionbio="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctlsocket_fionbio="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTLSOCKET_CAMEL
dnl -------------------------------------------------
dnl Verify if IoctlSocket is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_ioctlsocket_camel,
dnl then HAVE_IOCTLSOCKET_CAMEL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_IOCTLSOCKET_CAMEL], [
  AC_REQUIRE([CARL_INCLUDES_STROPTS])dnl
  #
  ...
  if test "$tst_compi_ioctlsocket_camel" = "yes"; then
    AC_MSG_CHECKING([if IoctlSocket usage allowed])
    if test "x$carl_disallow_ioctlsocket_camel" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_ioctlsocket_camel" = "yes" &&
    ...
    carl_cv_func_ioctlsocket_camel="yes"
    CARL_CHECK_FUNC_IOCTLSOCKET_CAMEL_FIONBIO
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctlsocket_camel="no"
  fi
])


dnl CARL_CHECK_FUNC_IOCTLSOCKET_CAMEL_FIONBIO
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_IOCTLSOCKET_CAMEL_FIONBIO], [
  #
  tst_compi_ioctlsocket_camel_fionbio="unknown"
  tst_allow_ioctlsocket_camel_fionbio="unknown"
  #
  if test "$carl_cv_func_ioctlsocket_camel" = "yes"; then
    AC_MSG_CHECKING([if IoctlSocket FIONBIO is compilable])
    AC_COMPILE_IFELSE([
      AC_LANG_PROGRAM([[
        $carl_includes_stropts
  ...
  if test "$tst_compi_ioctlsocket_camel_fionbio" = "yes"; then
    AC_MSG_CHECKING([if IoctlSocket FIONBIO usage allowed])
    if test "x$carl_disallow_ioctlsocket_camel_fionbio" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_ioctlsocket_camel_fionbio" = "yes" &&
    ...
    carl_cv_func_ioctlsocket_camel_fionbio="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_ioctlsocket_camel_fionbio="no"
  fi
])


dnl CARL_CHECK_FUNC_LISTXATTR
dnl -------------------------------------------------
dnl Verify if listxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_listxattr, then
dnl HAVE_LISTXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_LISTXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_listxattr" = "yes"; then
    ...
    if test "x$carl_disallow_listxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_listxattr" = "yes" &&
    ...
    #
    carl_cv_func_listxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_listxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_LOCALTIME_R
dnl -------------------------------------------------
dnl Verify if localtime_r is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_localtime_r, then
dnl HAVE_LOCALTIME_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_LOCALTIME_R], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_TIME])dnl
  #
  ...
  if test "$tst_compi_localtime_r" = "yes" &&
    ...
    if test "x$carl_disallow_localtime_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_localtime_r" = "yes" &&
    ...
    carl_cv_func_localtime_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_localtime_r="no"
  fi
])


dnl CARL_CHECK_FUNC_MEMRCHR
dnl -------------------------------------------------
dnl Verify if memrchr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_memrchr, then
dnl HAVE_MEMRCHR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_MEMRCHR], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_memrchr" = "yes"; then
    ...
    if test "x$carl_disallow_memrchr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if (test "$tst_proto_memrchr" = "yes" ||
    ...
    carl_cv_func_memrchr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_memrchr="no"
  fi
])


dnl CARL_CHECK_FUNC_POLL
dnl -------------------------------------------------
dnl Verify if poll is available, prototyped, can
dnl be compiled and seems to work. If all of these are
dnl true, and usage has not been previously disallowed
dnl with shell variable carl_disallow_poll, then
dnl HAVE_POLL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_POLL], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_POLL])dnl
  #
  ...
  if test "$tst_compi_poll" = "yes" &&
    ...
    if test "x$carl_disallow_poll" != "xyes"; then
      AC_MSG_RESULT([yes])
      tst_allow_poll="yes"
    else
      AC_MSG_RESULT([no])
  ...
  if test "$tst_links_poll" = "yes" &&
    ...
    carl_cv_func_poll="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_poll="no"
  fi
])


dnl CARL_CHECK_FUNC_REMOVEXATTR
dnl -------------------------------------------------
dnl Verify if removexattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_removexattr, then
dnl HAVE_REMOVEXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_REMOVEXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_removexattr" = "yes"; then
    ...
    if test "x$carl_disallow_removexattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_removexattr" = "yes" &&
    ...
    #
    carl_cv_func_removexattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_removexattr="no"
  fi
])


dnl CARL_CHECK_FUNC_SETSOCKOPT
dnl -------------------------------------------------
dnl Verify if setsockopt is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_setsockopt, then
dnl HAVE_SETSOCKOPT will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SETSOCKOPT], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  #
  ...
  if test "$tst_compi_setsockopt" = "yes"; then
    ...
    if test "x$carl_disallow_setsockopt" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_setsockopt" = "yes" &&
    ...
    carl_cv_func_setsockopt="yes"
    CARL_CHECK_FUNC_SETSOCKOPT_SO_NONBLOCK
  else
    AC_MSG_RESULT([no])
    carl_cv_func_setsockopt="no"
  fi
])


dnl CARL_CHECK_FUNC_SETSOCKOPT_SO_NONBLOCK
dnl -------------------------------------------------
...
AC_DEFUN([CARL_CHECK_FUNC_SETSOCKOPT_SO_NONBLOCK], [
  #
  tst_compi_setsockopt_so_nonblock="unknown"
  tst_allow_setsockopt_so_nonblock="unknown"
  #
  if test "$carl_cv_func_setsockopt" = "yes"; then
  ...
  if test "$tst_compi_setsockopt_so_nonblock" = "yes"; then
    ...
    if test "x$carl_disallow_setsockopt_so_nonblock" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_compi_setsockopt_so_nonblock" = "yes" &&
    ...
    carl_cv_func_setsockopt_so_nonblock="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_setsockopt_so_nonblock="no"
  fi
])


dnl CARL_CHECK_FUNC_SETXATTR
dnl -------------------------------------------------
dnl Verify if setxattr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_setxattr, then
dnl HAVE_SETXATTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SETXATTR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_XATTR])dnl
  #
  ...
  if test "$tst_compi_setxattr" = "yes"; then
    ...
    if test "x$carl_disallow_setxattr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_setxattr" = "yes" &&
    ...
    #
    carl_cv_func_setxattr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_setxattr="no"
  fi
])


dnl CARL_CHECK_FUNC_SIGACTION
dnl -------------------------------------------------
dnl Verify if sigaction is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_sigaction, then
dnl HAVE_SIGACTION will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SIGACTION], [
  AC_REQUIRE([CARL_INCLUDES_SIGNAL])dnl
  #
  ...
  if test "$tst_compi_sigaction" = "yes"; then
    ...
    if test "x$carl_disallow_sigaction" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_sigaction" = "yes" &&
    ...
    carl_cv_func_sigaction="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_sigaction="no"
  fi
])


dnl CARL_CHECK_FUNC_SIGINTERRUPT
dnl -------------------------------------------------
dnl Verify if siginterrupt is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_siginterrupt, then
dnl HAVE_SIGINTERRUPT will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SIGINTERRUPT], [
  AC_REQUIRE([CARL_INCLUDES_SIGNAL])dnl
  #
  ...
  if test "$tst_compi_siginterrupt" = "yes"; then
    ...
    if test "x$carl_disallow_siginterrupt" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_siginterrupt" = "yes" &&
    ...
    carl_cv_func_siginterrupt="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_siginterrupt="no"
  fi
])


dnl CARL_CHECK_FUNC_SIGNAL
dnl -------------------------------------------------
dnl Verify if signal is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_signal, then
dnl HAVE_SIGNAL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SIGNAL], [
  AC_REQUIRE([CARL_INCLUDES_SIGNAL])dnl
  #
  ...
  if test "$tst_compi_signal" = "yes"; then
    ...
    if test "x$carl_disallow_signal" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_signal" = "yes" &&
    ...
    carl_cv_func_signal="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_signal="no"
  fi
])


dnl CARL_CHECK_FUNC_SIGSETJMP
dnl -------------------------------------------------
dnl Verify if sigsetjmp is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_sigsetjmp, then
dnl HAVE_SIGSETJMP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SIGSETJMP], [
  AC_REQUIRE([CARL_INCLUDES_SETJMP])dnl
  #
  ...
  if test "$tst_compi_sigsetjmp" = "yes"; then
    ...
    if test "x$carl_disallow_sigsetjmp" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if (test "$tst_proto_sigsetjmp" = "yes" ||
    ...
    carl_cv_func_sigsetjmp="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_sigsetjmp="no"
  fi
])


dnl CARL_CHECK_FUNC_SOCKET
dnl -------------------------------------------------
dnl Verify if socket is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_socket, then
dnl HAVE_SOCKET will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SOCKET], [
  AC_REQUIRE([CARL_INCLUDES_WINSOCK2])dnl
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  AC_REQUIRE([CARL_INCLUDES_SOCKET])dnl
  #
  ...
  if test "$tst_compi_socket" = "yes"; then
    ...
    if test "x$carl_disallow_socket" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_socket" = "yes" &&
    ...
    carl_cv_func_socket="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_socket="no"
  fi
])


dnl CARL_CHECK_FUNC_SOCKETPAIR
dnl -------------------------------------------------
dnl Verify if socketpair is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_socketpair, then
dnl HAVE_SOCKETPAIR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_SOCKETPAIR], [
  AC_REQUIRE([CARL_INCLUDES_SYS_SOCKET])dnl
  AC_REQUIRE([CARL_INCLUDES_SOCKET])dnl
  #
  ...
  if test "$tst_compi_socketpair" = "yes"; then
    ...
    if test "x$carl_disallow_socketpair" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_socketpair" = "yes" &&
    ...
    carl_cv_func_socketpair="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_socketpair="no"
  fi
])


dnl CARL_CHECK_FUNC_STRCASECMP
dnl -------------------------------------------------
dnl Verify if strcasecmp is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strcasecmp, then
dnl HAVE_STRCASECMP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRCASECMP], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strcasecmp" = "yes"; then
    ...
    if test "x$carl_disallow_strcasecmp" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strcasecmp" = "yes" &&
    ...
    carl_cv_func_strcasecmp="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strcasecmp="no"
  fi
])

dnl CARL_CHECK_FUNC_STRCMPI
dnl -------------------------------------------------
dnl Verify if strcmpi is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strcmpi, then
dnl HAVE_STRCMPI will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRCMPI], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strcmpi" = "yes"; then
    ...
    if test "x$carl_disallow_strcmpi" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strcmpi" = "yes" &&
    ...
    carl_cv_func_strcmpi="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strcmpi="no"
  fi
])


dnl CARL_CHECK_FUNC_STRDUP
dnl -------------------------------------------------
dnl Verify if strdup is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strdup, then
dnl HAVE_STRDUP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRDUP], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strdup" = "yes"; then
    ...
    if test "x$carl_disallow_strdup" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strdup" = "yes" &&
    ...
    carl_cv_func_strdup="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strdup="no"
  fi
])


dnl CARL_CHECK_FUNC_STRERROR_R
dnl -------------------------------------------------
...
dnl previously disallowed with shell variable carl_disallow_strerror_r,
...
AC_DEFUN([CARL_CHECK_FUNC_STRERROR_R], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
...
#       include <errno.h>
  ...
  if test "$tst_allow_strerror_r" = "check"; then
    ...
    if test "x$carl_disallow_strerror_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strerror_r" = "yes" &&
    ...
    carl_cv_func_strerror_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strerror_r="no"
  fi
  #
  if test "$tst_compi_strerror_r" = "yes" &&
     test "$tst_allow_strerror_r" = "unknown"; then
    AC_MSG_WARN([cannot determine strerror_r() style: edit lib/carl_config.h manually.])
  fi
  #
])


dnl CARL_CHECK_FUNC_STRICMP
dnl -------------------------------------------------
dnl Verify if stricmp is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_stricmp, then
dnl HAVE_STRICMP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRICMP], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_stricmp" = "yes"; then
    ...
    if test "x$carl_disallow_stricmp" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_stricmp" = "yes" &&
    ...
    carl_cv_func_stricmp="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_stricmp="no"
  fi
])

dnl CARL_CHECK_FUNC_STRNCASECMP
dnl -------------------------------------------------
dnl Verify if strncasecmp is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strncasecmp, then
dnl HAVE_STRNCASECMP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRNCASECMP], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strncasecmp" = "yes"; then
    ...
    if test "x$carl_disallow_strncasecmp" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strncasecmp" = "yes" &&
    ...
    carl_cv_func_strncasecmp="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strncasecmp="no"
  fi
])


dnl CARL_CHECK_FUNC_STRNCMPI
dnl -------------------------------------------------
dnl Verify if strncmpi is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strncmpi, then
dnl HAVE_STRNCMPI will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRNCMPI], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strncmpi" = "yes"; then
    ...
    if test "x$carl_disallow_strncmpi" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strncmpi" = "yes" &&
    ...
    carl_cv_func_strncmpi="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strncmpi="no"
  fi
])


dnl CARL_CHECK_FUNC_STRNICMP
dnl -------------------------------------------------
dnl Verify if strnicmp is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strnicmp, then
dnl HAVE_STRNICMP will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRNICMP], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strnicmp" = "yes"; then
    ...
    if test "x$carl_disallow_strnicmp" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strnicmp" = "yes" &&
    ...
    carl_cv_func_strnicmp="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strnicmp="no"
  fi
])


dnl CARL_CHECK_FUNC_STRSTR
dnl -------------------------------------------------
dnl Verify if strstr is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strstr, then
dnl HAVE_STRSTR will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRSTR], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strstr" = "yes"; then
    ...
    if test "x$carl_disallow_strstr" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strstr" = "yes" &&
    ...
    carl_cv_func_strstr="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strstr="no"
  fi
])


dnl CARL_CHECK_FUNC_STRTOK_R
dnl -------------------------------------------------
dnl Verify if strtok_r is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strtok_r, then
dnl HAVE_STRTOK_R will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRTOK_R], [
  AC_REQUIRE([CARL_INCLUDES_STRING])dnl
  #
  ...
  if test "$tst_compi_strtok_r" = "yes"; then
    ...
    if test "x$carl_disallow_strtok_r" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strtok_r" = "yes" &&
    ...
    carl_cv_func_strtok_r="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strtok_r="no"
  fi
])


dnl CARL_CHECK_FUNC_STRTOLL
dnl -------------------------------------------------
dnl Verify if strtoll is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_strtoll, then
dnl HAVE_STRTOLL will be defined.

AC_DEFUN([CARL_CHECK_FUNC_STRTOLL], [
  AC_REQUIRE([CARL_INCLUDES_STDLIB])dnl
  #
  ...
  if test "$tst_compi_strtoll" = "yes"; then
    ...
    if test "x$carl_disallow_strtoll" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_strtoll" = "yes" &&
    ...
    carl_cv_func_strtoll="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_strtoll="no"
  fi
])


dnl CARL_CHECK_FUNC_WRITEV
dnl -------------------------------------------------
dnl Verify if writev is available, prototyped, and
dnl can be compiled. If all of these are true, and
dnl usage has not been previously disallowed with
dnl shell variable carl_disallow_writev, then
dnl HAVE_WRITEV will be defined.

AC_DEFUN([CARL_CHECK_FUNC_WRITEV], [
  AC_REQUIRE([CARL_INCLUDES_SYS_UIO])dnl
  #
  ...
  if test "$tst_compi_writev" = "yes"; then
    ...
    if test "x$carl_disallow_writev" != "xyes"; then
      AC_MSG_RESULT([yes])
  ...
  if test "$tst_links_writev" = "yes" &&
    ...
    carl_cv_func_writev="yes"
  else
    AC_MSG_RESULT([no])
    carl_cv_func_writev="no"
  fi
])
...
dnl CARL_LIBRARY_PATH variable. It keeps the LD_LIBRARY_PATH
dnl changes contained within this macro.

AC_DEFUN([CARL_RUN_IFELSE], [
   old=$LD_LIBRARY_PATH
   LD_LIBRARY_PATH=$CARL_LIBRARY_PATH:$old
