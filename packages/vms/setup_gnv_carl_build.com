...
$! Currently building carl on VMS with 64 bit pointers does not work.
$!
...
$ define/job decc$system_include prj_root:[.include.carl],-
    [-.packages.vms],-
...
$! that they need.
$!
$ define/job decc$user_include src_root:[.include.carl]
...
$!-----------------------------------------------
$ create [.src]gnv$carl.opt
$ open/append opt [.src]gnv$carl.opt
$ write opt "gnv_packages_vms:carlmsg.obj"
$ if libzshr_line .nes. "" then write opt libzshr_line
...
$! Create the libcarl
$!------------------------------------------------------
$ create 'default_dir'gnv_libcarl_linker.opt
$ open/append opt 'default_dir'gnv_libcarl_linker.opt
$ if libzshr_line .nes. "" then write opt libzshr_line
$ if gssrtlshr_line .nes. "" then write opt gssrtlshr_line
$ if libcryptoshr_line .nes. "" then write opt libcryptoshr_line
$ if libsslshr_line .nes. "" then write opt libsslshr_line
...
$ write opt "gnv_vms_common:vms_carl_init_unix.obj"
$ if libzshr_line .nes. "" then write opt libzshr_line
$ if gssrtlshr_line .nes. "" then write opt gssrtlshr_line
$ if libcryptoshr_line .nes. "" then write opt libcryptoshr_line
$ if libsslshr_line .nes. "" then write opt libsslshr_line
