...
$   if update_file
$   then
$       if f$search("src_root1:[000000]carl.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed src_root1:[carl]
$       endif
$   endif
$ endif
$!
...
$   if update_file
$   then
$       if f$search("vms_root1:[000000]carl.dir") .eqs. ""
$       then
$           create/dir/prot=o:rwed vms_root1:[carl]
$       endif
$   endif
$ endif
$!
...
$   if ref_fname .eqs. "$macinstall.txt" then ref_skip = 1
$   if ref_fname .eqs. "carl.mcp$5nxml$5nsit$5nhqx" then ref_skip = 1
$   if ref_fname .eqs. "carl_GUSIConfig.cpp" then ref_skip = 1
$   if ref_fname .eqs. "carl_$gusic$onfig.cpp" then ref_skip = 1
