$! File: PCSI_PRODUCT_GNV_CARL.COM
$!
$! $Id$
$!
$! This command file packages up the product CARL into a sequential
$! format kit
$!
...
$!---------------------------------------------------------
$ @BUILD_GNV_CARL_RELEASE_NOTES.COM
$!
$!
...
$ @backup_gnv_carl_src.com
$!
$! Regenerate the PCSI description file.
$!--------------------------------------
$ @BUILD_GNV_CARL_PCSI_DESC.COM
$!
$! Regenerate the PCSI Text file.
$!---------------------------------
$ @BUILD_GNV_CARL_PCSI_TEXT.COM
$!
$!
