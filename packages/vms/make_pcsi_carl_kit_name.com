$! File: MAKE_PCSI_CARL_KIT_NAME.COM
$!
$! $Id$
$!
...
$!
$!
$! We need to get the version from carlver_h.  It will have a line like
$! #define LIBCARL_VERSION "7.31.0"
$!   or
$! #define LIBCARL_VERSION "7.32.0-20130731".
$!
...
$   if f$locate("#define LIBCARL_VERSION ", line_in) .ne. 0
$   then
$       goto version_loop
$   endif
...
$! daiy snapshot of the carl source.
