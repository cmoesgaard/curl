$! File: Build_GNV_CARL_PCSI_DESC.COM
$!
$! $Id$
$!
...
$!      1. Duplicate filenames need an alias procedure. (N/A for carl)
$!      2. ODS-5 filenames need an alias procedure. (N/A for carl)
$!      3. Special alias links for executables (carl. -> carl.exe)
...
$!   Add file lines for carl.
$!   Add Link alias procedure file (N/A for carl)
$!   Add [.SYS$STARTUP]carl_startup file
$!   Add Release notes file.
$!
$! The file PCSI_GNV_CARL_FILE_LIST.TXT is read in to get the files other
...
$! Fortunately CARL does not trip most of these issues, so those steps
...
$! link [usr.bin]carl. for [usr.bin]carl.exe.
$!
...
$!---------------------------------------------------------------------
$ open/read flst pcsi_gnv_carl_file_list.txt
$!
$inst_alias_loop:
...
$ if kit_type .eqs. "D"
$ then
$   write pdsc "   file ""[sys$startup]carl_daily_startup.com"""
$ else
$   write pdsc "   file ""[sys$startup]carl_startup.com"""
$ endif
$ write pdsc "     source [usr.lib]carl_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -
