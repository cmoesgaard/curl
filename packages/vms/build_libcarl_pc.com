$! File: build_libcarl_pc.com
$!
$! $Id:$
$!
$! Build the libcarl.pc file from the libcarl.pc.in file
$!
...
$!===========================================================================
$!
$! Skip this if the libcarl.pc already exists.
$ if f$search("[--]libcarl.pc") .nes. "" then goto all_exit
$!
...
$!
$ pc_file_in = "[--]libcarl^.pc.in"
$!
$ if f$search(pc_file_in) .eqs. ""
$ then
$    pc_file_in = "[--]libcarl.pc$5nin"
$    if f$search(pc_file_in) .eqs. ""
$    then
$        pc_file_in = "[--]libcarl.pc_in"
$        if f$search(pc_file_in) .eqs. ""
$        then
$            write sys$output "Can not find libcarl.pc.in."
$            goto all_exit
$        endif
$    endif
$ endif
...
$   if name .eqs. "VERSION"
$   then
$       carl_version = f$element(2, " ", line_in) - """" - """"
$   else
$       goto version_loop
$   endif
$version_loop_end:
...
$    goto pc_file_loop
$ endif
$ if f$locate("@CARLVERSION@", line_in) .lt line_in_len
$ then
$    write pco "Version: ''carl_version'"
$    goto pc_file_loop
$ endif
$ if f$locate("@LIBCARL_LIBS@", line_in) .lt line_in_len
$ then
$    if arch_name .eqs. "VAX"
$    then
...
$    goto pc_file_loop
$ endif
$ if f$locate("@CPPFLAG_CARL_STATICLIB@", line_in) .lt line_in_len
$ then
$    write pco "Cflags: -I${includedir} -DCARL_STATICLIB"
$    goto pc_file_loop
$ endif
$!
$pc_file_loop_end:
