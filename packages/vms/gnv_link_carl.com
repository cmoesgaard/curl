$! File: gnv_link_carl.com
$!
$! $Id$
$!
$! File to build images using gnv$libcarl.exe
$!
...
$!--------------------------
$ if f$search("[.packages.vms]carlmsg.obj") .eqs. ""
$ then
$   message [.packages.vms]carlmsg.msg/object=[.packages.vms]
$ endif
$ if f$search("gnv$carlmsg.exe") .eqs. ""
$ then
$   link/share=gnv$carlmsg.exe [.packages.vms]carlmsg.obj
$ endif
$!
$!
...
$ init_obj = "[.packages.vms]carl_crtl_init.obj"
$ if f$search(init_obj) .eqs. ""
$ then
$   cc'cflags' 'default_dir'carl_crtl_init.c/obj='init_obj'
$ endif
$ purge 'init_obj'
$ rename 'init_obj' ;1
$!
...
$!
$!
$ base_link_opt_file = "[.packages.vms.''arch_name']gnv_libcarl_linker.opt"
$ share_link_opt_file = "[.packages.vms.''arch_name']gnv_ssl_libcarl_linker.opt"
$ if f$search(base_link_opt_file) .eqs. ""
$ then
$   base_link_opt_file = "[.packages.vms]gnv_libcarl_linker.opt"
$   share_link_opt_file = "[.packages.vms]gnv_ssl_libcarl_linker.opt"
$   if f$search(base_link_opt_file) .eqs. ""
$   then
...
$       carl_ssl_version = "OpenSSL/0.9.6g"
$   else
...
$   then
$       carl_ssl_version = hp_ssl_version
...
$       then
$           write sys$output -
   " HP OpenSSL version of ""''hp_ssl_version'"" is too old for shared libcarl!"
$       endif
$   else
...
$       then
$           write sys$output -
   "GNV OpenSSL version of ""''gnv_ssl_version'" is too old for shared libcarl!"
$       endif
$!
...
$           carl_ssl_version = gnv_ssl_version
$           use_hp_ssl = 0
$       endif
!$!
$   else
...
The [vms$common.sys$startup}carl_startup.com procedure will then configure
libcarl to use these shared images instead of the system ones.
...
$ write sslr "OpenSSL version used for building this kit: ",carl_ssl_version
$ write sslr ""
$ close sslr
$!
$!
...
$   write slopt "gnv$carl_ssl_libcryptoshr32/share"
$   write slopt "gnv$carl_ssl_libsslshr32/share"
$   close slopt
$ endif
$!
$! DCL build puts carllib in architecture directory
$! GNV build uses the makefile.
$ libfile = "[.packages.vms.''arch_name']carllib.olb"
$ if f$search(libfile) .nes. ""
$ then
$   olb_file = libfile
$ else
$   ! GNV based build
$   libfile = "[.lib.^.libs]libcarl.a"
$   if f$search(libfile) .nes. ""
$   then
$       olb_file = libfile
$   else
$       write sys$output -
  "Can not build shared image, libcarl object library not found!"
$       goto all_exit
$   endif
$ endif
$!
$gnv_libcarl_share = "''default_dir'gnv$libcarl.exe"
$!
$ if f$search(gnv_libcarl_share) .eqs. ""
$ then
$   if arch_name .nes. "VAX"
$   then
$       define/user gnv$carl_ssl_libcryptoshr32 'carl_ssl_libcrypto32'
$       define/user gnv$carl_ssl_libsslshr32 'carl_ssl_libssl32'
$       link/dsf='default_dir'gnv$libcarl.dsf/share='gnv_libcarl_share' -
            /map='default_dir'gnv$libcarl.map -
            gnv_packages_vms:gnv_libcarl_symbols.opt/opt,-
            'olb_file'/lib,-
...
$       link/share='gnv_libcarl_share'/map='default_dir'gnv$libcarl.map -
            gnv_packages_vms:gnv_libcarl_xfer.opt/opt,-
            'olb_file'/lib,-
...
$!
$!
$ if f$search("[.src]carl-tool_main.o") .nes. ""
$ then
$!  From src/makefile.inc:
$!  # libcarl has sources that provide functions named carlx_* that aren't
$!  # part of the official API, but we re-use the code here to avoid
$!  # duplication.
$!
$!
$   if f$search("[.src]carl.exe") .eqs. ""
$   then
$       define/user gnv$libcarl 'gnv_libcarl_share'
$       link'ldebug'/exe=[.src]carl.exe/dsf=[.src]carl.dsf -
           [.src]carl-tool_main.o, [.src]carl-tool_binmode.o, -
           [.src]carl-tool_bname.o, [.src]carl-tool_cb_dbg.o, -
           [.src]carl-tool_cb_hdr.o, [.src]carl-tool_cb_prg.o, -
           [.src]carl-tool_cb_rea.o, [.src]carl-tool_cb_see.o, -
           [.src]carl-tool_cb_wrt.o, [.src]carl-tool_cfgable.o, -
           [.src]carl-tool_convert.o, [.src]carl-tool_dirhie.o, -
           [.src]carl-tool_doswin.o, [.src]carl-tool_easysrc.o, -
           [.src]carl-tool_formparse.o, [.src]carl-tool_getparam.o, -
           [.src]carl-tool_getpass.o, [.src]carl-tool_help.o, -
           [.src]carl-tool_helpers.o, [.src]carl-tool_homedir.o, -
           [.src]carl-tool_hugehelp.o, [.src]carl-tool_libinfo.o, -
           [.src]carl-tool_metalink.o, [.src]carl-tool_mfiles.o, -
           [.src]carl-tool_msgs.o, [.src]carl-tool_operate.o, -
           [.src]carl-tool_operhlp.o, [.src]carl-tool_panykey.o, -
           [.src]carl-tool_paramhlp.o, [.src]carl-tool_parsecfg.o, -
           [.src]carl-tool_setopt.o, [.src]carl-tool_sleep.o, -
           [.src]carl-tool_urlglob.o, [.src]carl-tool_util.o, -
           [.src]carl-tool_vms.o, [.src]carl-tool_writeenv.o, -
           [.src]carl-tool_writeout.o, [.src]carl-tool_xattr.o, -
           [.src]carl-strtoofft.o, [.src]carl-strdup.o, [.src]carl-strcase.o, -
           [.src]carl-nonblock.o, gnv_packages_vms:carlmsg.obj,-
           sys$input:/opt
gnv$libcarl/share
gnv_packages_vms:carl_crtl_init.obj
$   endif
$ else
$   carl_exe = "[.src]carl.exe"
$   carl_dsf = "[.src]carl.dsf"
$   carl_main = "[.packages.vms.''arch_name']tool_main.obj"
$   carl_src = "[.packages.vms.''arch_name']carlsrc.olb"
$   carl_lib = "[.packages.vms.''arch_name']carllib.olb"
$   strcase = "strcase"
$   nonblock = "nonblock"
$   warnless = "warnless"
$!
...
$       warnless = """warnless"""
$   endif
$   if f$search(carl_exe) .eqs. ""
$   then
$       define/user gnv$libcarl 'gnv_libcarl_share'
$       link'ldebug'/exe='carl_exe'/dsf='carl_dsf' -
           'carl_main','carl_src'/lib, -
           'carl_lib'/library/include=-
           ('strcase','nonblock','warnless'),-
           gnv_packages_vms:carlmsg.obj,-
           sys$input:/opt
gnv$libcarl/share
gnv_packages_vms:carl_crtl_init.obj
$   endif
