$! File: GENERATE_CONFIG_H_CARL.COM
$!
$! $Id$
$!
$! Curl like most open source products uses a variant of a config.h file.
$! Depending on the carl version, this could be config.h or carl_config.h.
$!
$! For GNV based builds, the configure script is run and that produces
$! a [carl_]config.h file.  Configure scripts on VMS generally do not
...
$! VMS shared images.
$!
$! This generates a [carl_]config.h file and also a config_vms.h file,
...
$   write sys$output " This port of carl for VMS has not been tested with it."
...
$create sys$disk:[carl.lib]config_vms.h
$open/append cvh sys$disk:[carl.lib]config_vms.h
$!
...
$write cvh "#define carl_ca_path ""gnv$carl_ca_path"""
$!
...
$! to special case it for carl.  So we will fix it here.
$!
$! We do them all here, even the ones that config_h.com currently gets correct.
$!
$write cvh "#ifdef CARL_DISABLE_COOKIES"
$write cvh "#undef CARL_DISABLE_COOKIES"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_CRYPTO_AUTH"
$write cvh "#undef CARL_DISABLE_CRYPTO_AUTH"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_DICT"
$write cvh "#undef CARL_DISABLE_DICT"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_FILE"
$write cvh "#undef CARL_DISABLE_FILE"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_FTP"
$write cvh "#undef CARL_DISABLE_FTP"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_GOPHER"
$write cvh "#undef CARL_DISABLE_GOPHER"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_HTTP"
$write cvh "#undef CARL_DISABLE_HTTP"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_IMAP"
$write cvh "#undef CARL_DISABLE_IMAP"
$write cvh "#endif"
$if .not. noldap
$then
$   write cvh "#ifdef CARL_DISABLE_LDAP"
$   write cvh "#undef CARL_DISABLE_LDAP"
$   write cvh "#endif"
$   if .not. nossl
$   then
$	write cvh "#ifdef CARL_DISABLE_LDAPS"
$	write cvh "#undef CARL_DISABLE_LDAPS"
$	write cvh "#endif"
$   endif
$endif
$write cvh "#ifdef CARL_DISABLE_LIBCARL_OPTION"
$write cvh "#undef CARL_DISABLE_LIBCARL_OPTION"
$write cvh "#endif"
$write cvh "#ifndef __VAX"
$write cvh "#ifdef CARL_DISABLE_NTLM"
$write cvh "#undef CARL_DISABLE_NTLM"
$write cvh "#endif"
$write cvh "#else"
$! NTLM needs long long or int64 support, missing from DECC C.
$write cvh "#ifdef __DECC
$write cvh "#ifndef CARL_DISABLE_NTLM"
$write cvh "#define CARL_DISABLE_NTLM 1"
$write cvh "#endif"
$write cvh "#endif"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_POP3"
$write cvh "#undef CARL_DISABLE_POP3"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_PROXY"
$write cvh "#undef CARL_DISABLE_PROXY"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_RTSP"
$write cvh "#undef CARL_DISABLE_RTSP"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_SMTP"
$write cvh "#undef CARL_DISABLE_SMTP"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_TELNET"
$write cvh "#undef CARL_DISABLE_TELNET"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_TFTP"
$write cvh "#undef CARL_DISABLE_TFTP"
$write cvh "#endif"
$write cvh "#ifdef CARL_DISABLE_POP3"
$write cvh "#undef CARL_DISABLE_POP3"
$write cvh "#endif"
$if .not. nossl
$then
$   write cvh "#ifdef CARL_DISABLE_TLS_SRP"
$   write cvh "#undef CARL_DISABLE_TLS_SRP"
$   write cvh "#endif"
$!
$endif
$write cvh "#ifdef CARL_DISABLE_VERBOSE_STRINGS"
$write cvh "#undef CARL_DISABLE_VERBOSE_STRINGS"
$write cvh "#endif"
$!
...
$!
$! Note:
$! The CARL_EXTERN_SYMBOL is used for platforms that need the compiler
...
$!
$!
$! Suppress a message in carl_gssapi.c compile.
