...
$!
$! This generates the carl-config. script from the carl-config.in file.
$!
...
$!===========================================================================
$!
$! Skip this if the carl-config. already exists.
$ if f$search("[--]carl-config.") .nes. "" then goto all_exit
$!
...
$ x_cppflag_carl_staticlib = "-DCARL_STATICLIB"
$ x_enabled_shared = "no"
$ x_carl_ca_bundle = ""
$ x_cc = "cc"
...
$ then
$   x_libcarl_libs = part1
$ else
$   x_libcarl_libs = part1 + " -lgssapi"
$ endif
$ x_libext = "a"
$!
...
$!-----------------------
$ i = 0
$ open/read/error=version_loop_end vhf [--.include.carl]carlver.h
$ version_loop:
$   read/end=version_loop_end vhf line_in
$   if line_in .eqs. "" then goto version_loop
$   if f$locate("#define LIBCARL_VERSION ", line_in) .eq. 0
$   then
$       x_carlversion = f$element(2," ", line_in) - """" - """"
$       i = i + 1
$   endif
$   if f$locate("#define LIBCARL_VERSION_NUM ", line_in) .eq. 0
$   then
...
$!
$ kit_type = "V"
$ if f$locate("-", x_carlversion) .lt. f$length(x_carlversion)
$ then
$   kit_type = "D"
$   x_prefix = "/beta"
$   x_exec_prefix = "/beta"
...
$ part4 = "'--disable-ntlm-wb' '--with-ca-path=gnv$carl_ca_path'"""
$!
$ x_configure_options = part1 + part2 + part3 + part4
$!
$!
$ open/read/error=read_loop_end c_c_in sys$disk:[--]carl-config.in
$ create sys$disk:[--]carl-config.
$ open/append c_c_out sys$disk:[--]carl-config.
$read_loop:
