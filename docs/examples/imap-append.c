...
/* This is a simple example showing how to send mail using libcarl's IMAP
 * capabilities.
 *
...
int main(void)
{
  ...
  if(carl) {
    ...
    carl_easy_setopt(carl, CARLOPT_URL, "imap://imap.example.com/100");

    /* In this case, we're using a callback function to specify the data. You
     * could just use the CARLOPT_READDATA option to specify a FILE pointer to
     * read from. */
    ...
    carl_easy_setopt(carl, CARLOPT_INFILESIZE, infilesize);
