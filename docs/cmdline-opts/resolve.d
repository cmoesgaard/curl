...
can make the carl requests(s) use a specified address and prevent the
...
By specifying '*' as host you can tell carl to resolve any host and specific
...
is set to make carl use another IP version.

By prefixing the host with a '+' you can make the entry time out after carl's
...
is used carl will try to resolve the host as it normally would once the
timeout has expired.
