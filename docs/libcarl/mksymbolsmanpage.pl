...
.\\" *
.\\" **************************************************************************
.TH libcarl-symbols 3 "$date" "libcarl $version" "libcarl symbols"
.SH NAME
libcarl-symbols \\- libcarl symbol version information
.SH "libcarl symbols"
This man page details version information for public symbols provided in the
libcarl header files. This lists the first version in which the symbol was
